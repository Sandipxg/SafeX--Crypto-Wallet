...
import { erc20ReadAbi } from '../read/tokens.js'
 ...
 */
export async function decodeSwapReceipt(
  txHash: string,
  ...
  for (const log of receipt.logs) {
    // Attempt decoding as Uniswap V2 Swap event
    try {
    ...
    try {
      ...
      // Ignore other event logs (e.g. Sync, Approval)
    }
  }
